<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="News.aspx.vb" Inherits="NewsPage" Title="Fabrikam Inc: News" %>
            ...
            <asp:Panel ID="AllNewsPanel" runat="server">
                ...
                <asp:GridView ID="GridViewAllNews" runat="server" AutoGenerateColumns="False" DataSourceID="ObjectDataSourceAllNews"
                    ...
                    <Columns>
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:Image ID="Image2" runat="server" ImageUrl='<%# "images/" + Eval("ImageUrl") %>'
                                    AlternateText='<%# Eval("ImageAltText")%>' Width="160" Height="120" CssClass="photo-border photo-float-left" />
                                <h2>
                                    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "News.aspx?newsId=" + Eval("Id") %>'> 
                                        <%# Eval("Title")%>
                                    </asp:HyperLink>
                                </h2>
                                <p class="news-date">
                                ...
                                <asp:HyperLink ID="HyperLink5" runat="server" ImageUrl="images/arrow.gif" NavigateUrl='<%# "News.aspx?newsId=" + Eval("Id") %>'/> 
                                <asp:HyperLink ID="HyperLink4" runat="server" NavigateUrl='<%# "News.aspx?newsId=" + Eval("Id") %>'> 
                                    Read More
                                 </asp:HyperLink>
                            </ItemTemplate>
                        </asp:TemplateField>
