<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="Testimonials.aspx.vb" Inherits="TestimonialsPage" Title="Fabrikam Inc: Testimonials" %>
  ...
  -->
            <div id="content-main-three-column">
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="ObjectDataSource1"
                    BorderWidth="0" BorderColor="white" OnRowCreated="GridView1_RowCreated">
                    <Columns>
                        <asp:TemplateField>
                            <ItemTemplate>
                                <blockquote>
                                    ...
                                    <asp:Image ID="Image2" runat="server" ImageUrl='<%# "images/" + Eval("ImageUrl") %>'
                                        AlternateText='<%#Eval("ImageAltText")%>' CssClass="photo-border photo-float-left" />
                                    <p>
                                        <br />
                                        <%#Eval("Content")%>
                                    </p>
